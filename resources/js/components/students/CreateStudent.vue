...
<h1 class="text-2xl font-semibold p-4">New Students</h1>
    <x-splade-form action="/admin.students.store" class="p-4 bg-white rounded-md space-y-2">
        <x-splade-input name="first_name" label="First Name" />
        <x-splade-input name="last_name" label="Last Name" />
        <x-splade-input name="fathers_name" label="Last Name" />
        <x-splade-input name="mothers_name" label="Last Name" />
        ...
        <x-splade-checkbox name="is_still_in_learning_center" value="1" false-value="0" label="Is still in learning center" />
