<x-admin-layout>
    <div class="flex justify-between">
        <h1 class="text-2xl font-semibold pl-0 p-4">Designations List</h1>
        <div class="p-4 pr-0">
            <Link slideover href="{{ route('admin.designations.create') }}"
    ...
    <x-splade-table :for="$designations">
        @cell('action', $designation)
            <div class="space-x-2">
                <Link slideover href="{{ route('admin.designations.edit', $designation) }}"
