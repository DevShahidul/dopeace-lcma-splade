<x-admin-layout>
    <div class="flex justify-between">
        <h1 class="text-2xl font-semibold pl-0 p-4">Permissions List</h1>
        <div class="p-4 pr-0">
            <Link slideover href="{{ route('admin.permissions.create') }}"
    ...
    <x-splade-table :for="$permissions">
        @cell('action', $permission)
            <div class="space-x-2">
                <Link slideover href="{{ route('admin.permissions.edit', $permission) }}"
