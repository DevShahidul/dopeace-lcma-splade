<x-splade-modal>
    <h1 class="text-2xl font-semibold p-4">Edit Learning Center</h1>
    <x-splade-form :default="$learningCenter" :action="route('admin.learning-centers.update', $learningCenter)" method="PUT" class="p-4 bg-white rounded-md space-y-2">
